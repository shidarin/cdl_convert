...
from cdl_convert import (
    ColorCorrection, ColorCollection, ColorDecision, ColorCorrectionRef, 
    MediaRef, SopNode, SatNode, parse_file, write_cc, write_ccc, write_cdl, 
    write_rnh_cdl, sanity_check, to_decimal, ValidationError
)
...
class TestPublicAPICompatibility(unittest.TestCase):
    ...
    def test_color_correction_api_compatibility(self):
        ...
        self.assertEqual(cc.slope, (Decimal('1.0'), Decimal('1.0'), Decimal('1.0')))
        self.assertEqual(cc.offset, (Decimal('0.0'), Decimal('0.0'), Decimal('0.0')))
        self.assertEqual(cc.power, (Decimal('1.0'), Decimal('1.0'), Decimal('1.0')))
    ...
    def test_parse_functions_api_compatibility(self):
        ...
        from cdl_convert import parse_ale, parse_cc, parse_ccc, parse_cdl, parse_flex, parse_rnh_cdl
        
        parse_functions = [parse_ale, parse_cc, parse_ccc, parse_cdl, parse_flex, parse_rnh_cdl]
...
class TestCDLFormatOutputConsistency(unittest.TestCase):
    ...
    def test_ccc_format_output_consistency(self):
        ...
        self.assertTrue(len(created_files) > 0, f"No CCC files created in {self.temp_dir}")
    ...
    def test_cdl_format_output_consistency(self):
        ...
        if len(created_files) == 0:
            ...
            self.fail(f"No CDL files created in {self.temp_dir}. Files found: {all_files}")
    ...
    def test_rnh_cdl_format_output_consistency(self):
        ...
        expected_values = [
            '1.02401', '1.00804', '0.89562',  # slope
            '-0.00864', '-0.00261', '0.03612',  # offset
            '1.0', '1.0', '1.0',  # power
            '1.2'  # saturation
        ]
    ...
    def test_numeric_precision_consistency(self):
        ...
        self.assertIn('0.000000001', content)  # Should be fixed-point, not scientific notation
...
class TestBackwardCompatibilityBehavior(unittest.TestCase):
    ...
    def test_member_tracking_behavior_compatibility(self):
        ...
        try:
            ...
            self.assertTrue(cc3.id.startswith('tracked_cc1'))  # Should be based on original
    ...
    def test_file_path_handling_compatibility(self):
        ...
        cc_string_path = ColorCorrection(id='string_path_cc', input_file='test.cc')
        ...
        from pathlib import Path
        cc_path_obj = ColorCorrection(id='path_obj_cc', input_file=Path('test2.cc'))
        # file_in returns resolved absolute path
