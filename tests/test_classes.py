...
class TestAscColorSpaceBase(unittest.TestCase):
    ...
    def testInputDesc(self):
        ...
        self.assertTrue(hasattr(self.node, "input_desc"))

        self.assertEqual(None, self.node.input_desc)

        self.node.input_desc = "Sunset with an Eizo"

        self.assertEqual("Sunset with an Eizo", self.node.input_desc)
    ...
    def testViewingDesc(self):
        ...
        self.assertTrue(hasattr(self.node, "viewing_desc"))

        self.assertEqual(None, self.node.viewing_desc)

        self.node.viewing_desc = "Darker with a tinge of blah"

        self.assertEqual("Darker with a tinge of blah", self.node.viewing_desc)
    ...
    def test_parse_xml_input_desc(self, mock_elem):
        ...
        self.assertTrue(self.node.parse_xml_input_desc(mock_elem))

        self.assertEqual("Bob", self.node.input_desc)
        ...
        self.assertFalse(self.node.parse_xml_input_desc(mock_elem))

        self.assertEqual("Ralph", self.node.input_desc)
    ...
    def test_parse_xml_viewing_desc(self, mock_elem):
        ...
        self.assertTrue(self.node.parse_xml_viewing_desc(mock_elem))

        self.assertEqual("Bob", self.node.viewing_desc)
        ...
        self.assertFalse(self.node.parse_xml_viewing_desc(mock_elem))

        self.assertEqual("Ralph", self.node.viewing_desc)
...
class TestAscDescBase(unittest.TestCase):
    ...
    def testInit(self):
        ...
        self.assertEqual([], self.node.desc)
    ...
    def testAppendAdditional(self):
        ...
        self.assertEqual(
            ["first description", "second description"], self.node.desc
        )
    ...
    def testReplaceWithList(self):
        ...
        self.assertEqual(
            ["second description", "third description"], self.node.desc
        )
    ...
    def testReplaceDescCompletely(self):
        """Tests completely replacing desc with a new list"""
        ...
        self.assertEqual(
            ["forth description", "fifth description", "sixth description"],
            self.node.desc,
        )
...
class TestColorCollection(unittest.TestCase):
    ...
    def testDesc(self):
        ...
        self.assertTrue(hasattr(self.node, "desc"))
    ...
    def testIdList(self):
        ...
        self.assertEqual([], self.node.id_list)

        self.node.append_child(cdl_convert.ColorCorrection("001"))

        self.assertEqual(["001"], self.node.id_list)

        self.node.append_child(cdl_convert.ColorCorrection("002"))

        self.assertEqual(["001", "002"], self.node.id_list)
        ...
        self.assertEqual(["001", "002", "003"], self.node.id_list)
    ...
    def testIsCCC(self):
        ...
        self.assertTrue(self.node.is_ccc)

        self.node._type = "cdl"

        self.assertFalse(self.node.is_ccc)

    # ==========================================================================

    def testIsCDL(self):
        """Tests that is_cdl works correctly"""
        self.assertFalse(self.node.is_cdl)

        self.node._type = "cdl"

        self.assertTrue(self.node.is_cdl)
    ...
    def testType(self):
        ...
        self.assertRaises(ValueError, setType)
    ...
    def testXmlns(self):
        ...
        self.assertRaises(AttributeError, setXML)

        self.assertEqual("urn:ASC:CDL:v1.01", self.node.xmlns)
    ...
    def testSetToCCC(self):
        ...
        self.assertEqual("ccc", self.node._type)
    ...
    def testSetToCDL(self):
        ...
        self.assertEqual("cdl", self.node._type)
    ...
    def testFileInRead(self):
        ...
        self.assertEqual(expected_path, self.node.file_in)

    # ==========================================================================

    def testFileInReturnsResolvedPath(self):
        """Tests that file_in setter returns the resolved absolute path"""
        self.assertEqual(None, self.node.file_in)
    ...
    def testFileOutSetException(self):
        ...
        self.assertRaises(AttributeError, testFileOut)
    ...
    def testParseXMLColorCorrectionsMultiFound(self, mock_parse):
        ...
        self.assertTrue(self.node.parse_xml_color_corrections(xml_element))

        mock_parse.assert_has_calls(
            [mock.call("banana"), mock.call("apple"), mock.call("egg")]
        )

        self.assertEqual(self.node, mock_cdl.parent)

        # Tests that the returned mock_cdls were added to the color_corrections
        # list.
        self.assertEqual(
            [mock_cdl, mock_cdl, mock_cdl], self.node.color_corrections
        )
    ...
    def testParseXMLColorCorrectionsNoneFound(self):
        ...
        self.assertFalse(self.node.parse_xml_color_corrections(xml_element))
    ...
    def testDetermineDest(self):
        ...
        self.assertEqual(expected_out, self.node.file_out)
    ...
    def testDetermineDestNoFileIn(self):
        ...
        self.assertEqual(
            Path("converted/color_collection_003.ccc"), self.node.file_out
        )
...
class TestCollectionChildMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.color_decisions = [
            ...
            cdl_convert.ColorDecision(cdl_convert.ColorCorrectionRef("005")),
        ]
    ...
    def testRetrieveColorCorrections(self):
        ...
        self.assertEqual(self.color_corrections, self.node.color_corrections)
    ...
    def testRetrieveColorDecisions(self):
        ...
        self.assertEqual(self.color_decisions, self.node.color_decisions)
    ...
    def testAppendChildCorrection(self):
        ...
        self.assertEqual(
            [self.color_corrections[0]], self.node.color_corrections
        )
    ...
    def testAppendChildDecision(self):
        ...
        self.assertEqual([self.color_decisions[0]], self.node.color_decisions)

    # ==========================================================================

    def testAppendChildBadType(self):
        """Tries appending a child to Collection that's not the right type"""
        self.assertRaises(TypeError, self.node.append_child, "I ama a banana")
    ...
    def testAppendDuplicateCorrection(self):
        ...
        self.assertRaises(ValueError, append)
    ...
    def testAppendDuplicateMixed(self):
        ...
        self.assertFalse(self.node.append_child(cd))

        self.assertEqual([self.color_corrections[0]], self.node.all_children)

        cdl_convert.config.config.halt_on_error = True

        self.assertRaises(ValueError, self.node.append_child, cd)

    # ==========================================================================

    def testAppendChildren(self):
        """Tries appending multiple children of different types"""
        self.node.append_children(self.color_corrections + self.color_decisions)
    ...
    def testSetColorCorrectionsNone(self):
        ...
        self.assertEqual([], self.node.color_corrections)
    ...
    def testSetColorCorrectionList(self):
        ...
        self.assertEqual(
            list(set(self.color_corrections)), self.node.color_corrections
        )
    ...
    def testSetColorCorrectonBadType(self):
        ...
        self.assertRaises(TypeError, setNode)
    ...
    def testSetColorCorrectionListBad(self):
        ...
        def setNode():
            self.node.color_corrections = [self.color_corrections[0], "banana"]
    ...
    def testSetColorDecisionsNone(self):
        ...
        self.assertEqual([], self.node.color_decisions)
    ...
    def testSetColorDecisionList(self):
        ...
        # so the order matches
        self.assertEqual(
            list(set(self.color_decisions)), self.node.color_decisions
        )
    ...
    def testSetColorDecisionBadType(self):
        """Tests trying to set color_decisions with a bad type"""
    ...
    def testSetColorDecisionListBad(self):
        ...
        def setNode():
            self.node.color_decisions = [self.color_decisions[0], "banana"]
    ...
    def testSetParent(self):
        ...
        for child in self.node.all_children:
            ...
            child.parent = "banana"
            self.assertEqual("banana", child.parent)
...
class TestMultipleCollections(unittest.TestCase):
    ...
    def testCopyCollection(self):
        ...
        self.assertEqual(self.node.type, copy.type)

        self.assertEqual(self.node.desc, copy.desc)

        self.assertEqual(self.node.input_desc, copy.input_desc)

        self.assertEqual(self.node.viewing_desc, copy.viewing_desc)

        self.assertEqual(self.node.all_children, copy.all_children)
    ...
    def testMergeCollectionsCCCParent(self):
        ...
        self.assertEqual(self.node.desc + self.node2.desc, merged.desc)
        self.assertEqual(self.node.input_desc, merged.input_desc)
        self.assertEqual(self.node.viewing_desc, merged.viewing_desc)
        self.assertCountEqual(
            self.node.all_children + self.node2.all_children,
            merged.all_children,
        )
        self.assertEqual(self.node.type, merged.type)
    ...
    def testMergeCollectionsCDLParent(self):
        ...
        self.assertEqual(self.node2.desc + self.node.desc, merged.desc)
        self.assertEqual(self.node2.input_desc, merged.input_desc)
        self.assertEqual(self.node2.viewing_desc, merged.viewing_desc)
        self.assertCountEqual(
            self.node.all_children + self.node2.all_children,
            merged.all_children,
        )
        self.assertEqual(self.node2.type, merged.type)
...
class TestColorCorrection(unittest.TestCase):
    ...
    def testInputDesc(self):
        ...
        self.assertTrue(hasattr(self.cc, "input_desc"))

        self.assertEqual(None, self.cc.input_desc)
    ...
    def testViewingDesc(self):
        ...
        self.assertTrue(hasattr(self.cc, "viewing_desc"))

        self.assertEqual(None, self.cc.viewing_desc)
    ...
    def testDesc(self):
        ...
        self.assertTrue(hasattr(self.cc, "desc"))

        self.assertEqual([], self.cc.desc)

    # ==========================================================================

    def testFileInReturn(self):
        """Tests that calling ColorCorrection.fileIn returns the file given"""
        self.assertEqual(Path("../testcdl.cc").resolve(), self.cc.file_in)
    ...
    def testIdReturn(self):
        ...
        self.assertEqual("uniqueId", self.cc.id)
    ...
    def testIdNonUniqueIdOnInit(self):
        ...
        self.assertRaises(
            ValueError, cdl_convert.ColorCorrection, "uniqueId", "file"
        )
        ...
        self.assertEqual("uniqueId001", cc.id)
    ...
    def testIdNonUniqueIdOnSet(self):
        ...
        self.assertRaises(ValueError, setId, new)
    ...
    def testBlankId(self):
        ...
        self.assertEqual("001", cdl1.id)

        cdl2 = cdl_convert.ColorCorrection("", "file")

        self.assertEqual("002", cdl2.id)

        cdl_convert.config.config.halt_on_error = True

        self.assertRaises(ValueError, cdl_convert.ColorCorrection, "", "file")
    ...
    def testHasSat(self):
        ...
        self.assertFalse(self.cc.has_sat)

        # Access property to trigger lazy initialization of sat node
        self.cc.sat_node  # noqa: B018

        self.assertTrue(self.cc.has_sat)
    ...
    def testHasSop(self):
        ...
        self.assertFalse(self.cc.has_sop)

        # Access property to trigger lazy initialization of sop node
        self.cc.sop_node  # noqa: B018

        self.assertTrue(self.cc.has_sop)
    ...
    def testOffsetSetAndGet(self):
        ...
        self.assertEqual(offsetD, self.cc.offset)
    ...
    def testOffsetBadLength(self):
        ...
        self.assertRaises(ValueError, setOffset)
    ...
    def testOffsetSetStrings(self):
        ...
        self.assertRaises(TypeError, setOffset)
    ...
    def testOffsetBecomesTuple(self):
        ...
        offset = [
            Decimal("-1.3782"),
            Decimal("278.32"),
            Decimal("0.738378233782"),
        ]

        self.cc.offset = offset

        self.assertEqual(tuple(offset), self.cc.offset)
    ...
    def testPowerSetAndGet(self):
        ...
        self.assertEqual(powerD, self.cc.power)
    ...
    def testPowerSetNegative(self):
        ...
        self.assertRaises(ValueError, setPower)
    ...
    def testPowerSetStrings(self):
        ...
        self.assertRaises(TypeError, setPower)
    ...
    def testPowerBecomesTuple(self):
        ...
        self.assertEqual(tuple(power), self.cc.power)
    ...
    def testSlopeSetAndGet(self):
        ...
        self.assertEqual(slopeD, self.cc.slope)
    ...
    def testSlopeSetNegative(self):
        ...
        self.assertRaises(ValueError, setSlope)
    ...
    def testSlopeSetStrings(self):
        ...
        self.assertRaises(TypeError, setSlope)
    ...
    def testSlopeBecomesTuple(self):
        ...
        self.assertEqual(tuple(slope), self.cc.slope)
    ...
    def testSatSetAndGet(self):
        ...
        self.assertEqual(satD, self.cc.sat)
    ...
    def testSatSetNegative(self):
        ...
        self.assertRaises(ValueError, setSat)

        cdl_convert.config.config.halt_on_error = False

        setSat()

        self.assertEqual(Decimal("0.0"), self.cc.sat)
    ...
    def testSatSetString(self):
        ...
        self.assertRaises(TypeError, setSat)
    ...
    def testSatBecomesDecimal(self):
        ...
        self.assertEqual(Decimal(sat), self.cc.sat)
    ...
    def testDetermineDest(self):
        ...
        self.assertEqual(expected_path, self.cc.file_out)
...
class TestColorCorrectionReference(unittest.TestCase):
    ...
    def testCC(self):
        ...
        self.assertEqual(self.cc, self.ccr.cc)

        self.assertEqual(None, self.ccr_bad.cc)
    ...
    def testCCHalt(self):
        ...
        def getCC():
            self.ccr_bad.cc  # noqa: B018 - intentional property access to trigger error

        self.assertRaises(ValueError, getCC)

    # ==========================================================================

    def testRef(self):
        """Tests that id is returned correctly"""
        self.assertEqual("uniqueId", self.ccr.id)

        self.assertEqual("oldId", self.ccr_bad.id)
    ...
    def testChangeRefHALT(self):
        ...
        self.assertRaises(ValueError, setRef)
    ...
    def testBuildElement(self):
        ...
        self.assertEqual('<ColorCorrectionRef ref="uniqueId"/>\n', self.ccr.xml)
    ...
    def testResetMembers(self):
        ...
        self.assertEqual({}, cdl_convert.ColorCorrectionRef.members)
...
class TestColorDecision(unittest.TestCase):
    ...
    def testInputDesc(self):
        ...
        self.assertTrue(hasattr(self.cd, "input_desc"))

        self.assertEqual(None, self.cd.input_desc)
    ...
    def testViewingDesc(self):
        ...
        self.assertTrue(hasattr(self.cd, "viewing_desc"))
    ...
    def testDesc(self):
        ...
        self.assertTrue(hasattr(self.cd, "desc"))
    ...
    def testParentage(self):
        ...
        self.assertEqual(self.cd, self.media_ref.parent)

        self.assertEqual(self.cd, self.cc.parent)
    ...
    def testParentageChange(self):
        ...
        self.assertEqual(self.cd, cc2.parent)

        self.assertEqual(self.cd, mr2.parent)
    ...
    def testMemberListDefault(self):
        ...
        self.assertEqual(
            {"uniqueId": [self.cd]}, cdl_convert.ColorDecision.members
        )
    ...
    def testMemberListOnIdChange(self):
        ...
        self.assertEqual({"001": [self.cd]}, cdl_convert.ColorDecision.members)
    ...
    def testMemberListGrowing(self):
        ...
        self.assertEqual(
            {"uniqueId": [self.cd, cd2]}, cdl_convert.ColorDecision.members
        )
    ...
    def testCC(self):
        ...
        self.assertEqual(self.cc, self.cd.cc)

    # ==========================================================================

    def testIsRef(self):
        """Tests that is_ref responds correctly"""
        self.assertFalse(self.cd.is_ref)

        self.cd.cc = cdl_convert.ColorCorrectionRef("001")

        self.assertTrue(self.cd.is_ref)

    # ==========================================================================

    def testMediaRef(self):
        """Tests that media ref returns"""
        self.assertEqual(self.media_ref, self.cd.media_ref)

        self.cd.media_ref = None

        self.assertEqual(None, self.cd.media_ref)

        self.media_ref.parent = "bob"

        self.cd.media_ref = self.media_ref

        self.assertEqual(self.cd, self.cd.media_ref.parent)
    ...
    def testResetMembers(self):
        ...
        self.assertEqual({}, cdl_convert.ColorDecision.members)
...
class TestMediaRefProperties(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mr = cdl_convert.MediaRef(ref_uri=self.ref, parent=self.parent)
    ...
    def testParent(self):
        ...
        self.assertEqual(self.parent, self.mr.parent)
    ...
    def testMembership(self):
        ...
        self.assertEqual({self.ref: [self.mr]}, cdl_convert.MediaRef.members)

    # ==========================================================================

    def testDirectoryReturn(self):
        """Tests that directory returns correctly"""
        self.assertEqual(self.directory, self.mr.directory)

        self.mr.directory = "burp"

        self.assertEqual("burp", self.mr.directory)
    ...
    def testDirectorySetString(self, mock_cm, mock_rcp):
        ...
        self.assertEqual(new_directory, self.mr.directory)
        ...
        self.assertEqual(new_ref, self.mr.ref)

        mock_cm.assert_called_once_with(old_ref=old_ref)
    ...
    def testDirectorySetBadType(self):
        ...
        self.assertRaises(TypeError, setDirectory)
    ...
    def testExists(self, mock_exists):
        ...
        self.assertTrue(self.mr.exists)

        mock_exists.assert_called_once_with()

        mock_exists.return_value = False

        self.assertFalse(self.mr.exists)

    # ==========================================================================

    def testFilenameReturn(self):
        """Tests that filename returns correctly"""
        self.assertEqual(self.filename, self.mr.filename)

        self.mr.filename = "burp"

        self.assertEqual("burp", self.mr.filename)
    ...
    def testFilenameSetString(self, mock_cm, mock_rcp):
        ...
        self.assertEqual(new_filename, self.mr.filename)
    ...
    def testFilenameSetBadType(self):
        ...
        self.assertRaises(TypeError, setFilename)
    ...
    def testIsAbs(self, mock_abs):
        ...
        self.assertTrue(self.mr.is_abs)

        mock_abs.assert_called_once_with()

        mock_abs.return_value = False

        self.assertFalse(self.mr.is_abs)
    ...
    def testIsDir(self, mock_dir):
        ...
        self.assertTrue(self.mr.is_dir)

        mock_dir.assert_called_once_with()

        mock_dir.return_value = False

        self.assertFalse(self.mr.is_dir)
    ...
    def testIsSeq(self, mock_seq):
        ...
        self.mr._sequence_info = SequenceInfo(
            is_sequence=True, sequences=["test"]
        )

        self.assertEqual(True, self.mr.is_seq)

        self.assertFalse(mock_seq.called)
    ...
    def testPathNoMock(self):
        ...
        self.assertEqual(
            os.path.join(self.directory, self.filename), self.mr.path
        )
    ...
    def testProtocolReturn(self):
        ...
        self.assertEqual(self.protocol, self.mr.protocol)

        self.mr.protocol = "burp"

        self.assertEqual("burp", self.mr.protocol)
    ...
    def testProtocolSetString(self, mock_cm, mock_rcp):
        ...
        self.assertEqual(new_protocol, self.mr.protocol)
    ...
    def testProtocolSetBadType(self):
        ...
        self.assertRaises(TypeError, setProtocol)
    ...
    def testProtocolTruncate(self):
        ...
        self.assertEqual("aladdin", self.mr.protocol)

    # ==========================================================================

    def testRef(self):
        """Tests that ref returns correctly"""
        self.assertEqual(self.ref, self.mr.ref)
    ...
    def testSetRefWithProtocol(self, mock_cm, mock_rcp):
        ...
        new_ref = "edward://" + os.path.join(
            "loves/to/eat/snow/in/the", "winter.#####.ned"
        )
        self.mr.ref = new_ref

        self.assertEqual(new_ref, self.mr.ref)

        self.assertEqual("edward", self.mr.protocol)

        self.assertEqual("loves/to/eat/snow/in/the", self.mr.directory)

        self.assertEqual("winter.#####.ned", self.mr.filename)

        mock_cm.assert_called_once_with(old_ref=self.ref)
        mock_rcp.assert_called_once_with()
    ...
    def testSetRefNoProtocol(self, mock_cm, mock_rcp):
        ...
        self.assertEqual("", self.mr.protocol)
    ...
    def testSetRefBadType(self):
        ...
        self.assertRaises(TypeError, setRef)
    ...
    def testSeqs(self, mock_gs):
        ...
        self.assertEqual(["apple", "banana"], self.mr.seqs)
...
class TestMediaRefChangeMembership(unittest.TestCase):
    ...
    def testNormalOperation(self):
        ...
        self.assertEqual({"hello": [self.mr]}, cdl_convert.MediaRef.members)
        ...
        self.assertEqual({"goodbye": [self.mr]}, cdl_convert.MediaRef.members)
    ...
    def testMultipleNewRefs(self):
        ...
        self.assertEqual(
            {"goodbye": [self.mr2, self.mr]}, cdl_convert.MediaRef.members
        )
    ...
    def testMultipleOldRefs(self):
        ...
        self.assertEqual(
            {"hello": [self.mr, self.mr2]}, cdl_convert.MediaRef.members
        )
...
class TestMediaRefGetSequences(unittest.TestCase):
    ...
    def testSingleFile(self, mock_dir):
        ...
        self.assertEqual(self.is_seq, self.mr.is_seq)

        self.assertEqual(self.seq, self.mr.seq)

        if self.seq:
            self.assertEqual([self.seq], self.mr.seqs)
        else:
            self.assertEqual([], self.mr.seqs)
    ...
    def testDirExists(self, mock_dir, mock_exists, mock_iterdir):
        ...
        if len(self.seqs) > 0:
            self.assertEqual(self.seqs[0], self.mr.seq)
        else:
            self.assertEqual(None, self.mr.seq)

        self.assertEqual(self.seqs, self.mr.seqs)
    ...
    @mock.patch("os.path.isdir")
    def testDirDoesNotExist(
        self, mock_os_isdir, mock_os_exists, mock_path_is_dir, mock_path_exists
    ):
        ...
        self.assertRaises(ValueError, self.mr._get_sequences)

        cdl_convert.config.config.halt_on_error = False

        self.assertEqual(False, self.mr.is_seq)
...
class TestSatNode(unittest.TestCase):
    ...
    def testParent(self):
        ...
        self.assertEqual(self, self.node.parent)
    ...
    def testSetParent(self):
        ...
        self.assertRaises(AttributeError, setParent)

    # ==========================================================================

    def testDefault(self):
        """Tests that saturation starts off with a default value of 1.0"""
        self.assertEqual(Decimal("1.0"), self.node.sat)
    ...
    def testSetWithString(self):
        ...
        self.assertEqual(Decimal("12.3"), self.node.sat)
    ...
    def testSetWithNegativeString(self):
        ...
        self.assertEqual(Decimal("0.0"), self.node.sat)
    ...
    def testSetWithFloat(self):
        ...
        self.assertEqual(Decimal("100.1"), self.node.sat)
    ...
    def testSetWithInt(self):
        ...
        self.assertEqual(Decimal("2.0"), self.node.sat)
...
class TestSopNode(unittest.TestCase):
    ...
    def testSlopeDefault(self):
        ...
        self.assertEqual(
            (Decimal("1.0"), Decimal("1.0"), Decimal("1.0")), self.node.slope
        )
    ...
    def testSetSlopeWithString(self):
        ...
        self.assertEqual(
            (Decimal("12.3"), Decimal("12.3"), Decimal("12.3")), self.node.slope
        )
    ...
    def testSetSlopeWithNegativeString(self):
        ...
        self.assertEqual(
            (Decimal("0.0"), Decimal("0.0"), Decimal("0.0")), self.node.slope
        )
    ...
    def testSetSlopeWithInt(self):
        ...
        self.assertEqual((2, 2, 2), self.node.slope)
    ...
    def testSlopeBecomesTuple(self):
        ...
        self.assertEqual(slopeD, self.node.slope)
    ...
    def testOffsetDefault(self):
        ...
        self.assertEqual(
            (Decimal("0.0"), Decimal("0.0"), Decimal("0.0")), self.node.offset
        )
    ...
    def testSetOffsetWithInt(self):
        ...
        self.assertEqual((2, 2, 2), self.node.offset)
    ...
    def testOffsetSetNegative(self):
        ...
        self.assertEqual(offsetD, self.node.offset)
    ...
    def testPowerDefault(self):
        ...
        self.assertEqual(
            (Decimal("1.0"), Decimal("1.0"), Decimal("1.0")), self.node.power
        )
    ...
    def testSetPowerWithString(self):
        ...
        self.assertEqual(
            (Decimal("12.3"), Decimal("12.3"), Decimal("12.3")), self.node.power
        )
    ...
    def testSetPowerWithNegativeString(self):
        ...
        self.assertEqual(
            (Decimal("0.0"), Decimal("0.0"), Decimal("0.0")), self.node.power
        )
    ...
    def testSetPowerWithInt(self):
        ...
        self.assertEqual((2, 2, 2), self.node.power)
    ...
    def testPowerBecomesTuple(self):
        ...
        self.assertEqual(powerD, self.node.power)
...
class TestColorValues(unittest.TestCase):
    ...
    def testDefaultValues(self):
        ...
        self.assertEqual(
            (Decimal("1.0"), Decimal("1.0"), Decimal("1.0")), cv.slope
        )
        self.assertEqual(
            (Decimal("0.0"), Decimal("0.0"), Decimal("0.0")), cv.offset
        )
        self.assertEqual(
            (Decimal("1.0"), Decimal("1.0"), Decimal("1.0")), cv.power
        )
        self.assertEqual(Decimal("1.0"), cv.saturation)
    ...
    def testCustomValues(self):
        ...
        self.assertEqual(
            (Decimal("1.2"), Decimal("1.1"), Decimal("1.0")), cv.slope
        )
        self.assertEqual(
            (Decimal("0.1"), Decimal("-0.05"), Decimal("0.0")), cv.offset
        )
        self.assertEqual(
            (Decimal("0.9"), Decimal("1.0"), Decimal("1.1")), cv.power
        )
        self.assertEqual(Decimal("1.2"), cv.saturation)
    ...
    def testValidationBadSlopeLength(self):
        ...
        self.assertRaises(ValueError, createBadColorValues)
    ...
    def testToUnity(self):
        ...
        self.assertEqual(
            (Decimal("1.0"), Decimal("1.0"), Decimal("1.0")), unity.slope
        )
        self.assertEqual(Decimal("1.0"), unity.saturation)
...
class TestMediaRefInfo(unittest.TestCase):
    ...
    def testCustomValues(self):
        ...
        mri = MediaRefInfo(
            protocol="http", directory="/path/to/files", filename="image.jpg"
        )
    ...
    def testToUriWithProtocol(self):
        ...
        mri = MediaRefInfo(
            protocol="http", directory="example.com/path", filename="file.jpg"
        )
    ...
    def testToUriNoProtocol(self):
        ...
        mri = MediaRefInfo(directory="path/to/files", filename="image.jpg")
    ...
    def testToUriNoFilename(self):
        ...
        mri = MediaRefInfo(protocol="file", directory="/path/to/directory")
